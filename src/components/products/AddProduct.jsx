  ...
  return (
    <div className='w-full h-full fixed left-0 top-0 flex items-center justify-center bg-black/30 z-30'>
        ...
        <div className='bg-white rounded-sm shadow-sm flex flex-col gap-4 p-6 w-full sm:w-96 z-50'>
            ...
            <input type="text" placeholder='قیمت محصول را به تومان وارد کنید' className='bg-light rounded-sm px-2 py-1 w-full' value={price} onChange={(e) => setPrice(e.target.value)}/>
            <input type="text" placeholder='موجودی محصول را وارد کنید' className='bg-light rounded-sm px-2 py-1 w-full' value={stock} onChange={(e) => setStock(e.target.value)}/>
            <input type="text" placeholder='امتیاز محصول را وارد کنید' className='bg-light rounded-sm px-2 py-1 w-full' value={rate} onChange={(e) => setRate(e.target.value)}/>
