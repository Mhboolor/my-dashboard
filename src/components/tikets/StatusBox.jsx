    ...
    <div className="flex gap-6 flex-wrap">
      <div className="flex items-center justify-between bg-white dark:bg-[#36404a] shadow-sm flex-1 p-6 rounded-sm ">
        ...
        <div className="flex flex-col items-end gap-1">
          <p className="text-gray-5 text-2xl font-semibold dark:text-[#f3f7f9]">3,947</p>
          <p className="text-sm text-gray-2 dark:text-[#8c98a5]">مجموع تیکت ها</p>
        </div>
      </div>
      <div className="flex items-center justify-between bg-white dark:bg-[#36404a] shadow-sm flex-1 p-6 rounded-sm ">
        ...
        <div className="flex flex-col items-end gap-1">
          <p className="text-gray-5 text-2xl font-semibold dark:text-[#f3f7f9]">624</p>
          <p className="text-sm text-gray-2 dark:text-[#8c98a5]">تیکت های در انتظار</p>
        </div>
      </div>
      <div className="flex items-center justify-between bg-white dark:bg-[#36404a] shadow-sm flex-1 p-6 rounded-sm ">
        ...
        <div className="flex flex-col items-end gap-1">
          <p className="text-gray-5 text-2xl font-semibold dark:text-[#f3f7f9]">3195</p>
          <p className="text-sm text-gray-2 dark:text-[#8c98a5]">تیکت های بسته شده</p>
        </div>
      </div>
      <div className="flex items-center justify-between bg-white dark:bg-[#36404a] shadow-sm flex-1 p-6 rounded-sm ">
        ...
        <div className="flex flex-col items-end gap-1">
          <p className="text-gray-5 text-2xl font-semibold dark:text-[#f3f7f9]">128</p>
          <p className="text-sm text-gray-2 dark:text-[#8c98a5]">تیکت های پاک شده</p>
        </div>
      </div>
    </div>
  )
